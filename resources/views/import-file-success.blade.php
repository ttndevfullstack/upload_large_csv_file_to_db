...
<body>
    <div id="webcrumbs">
        <div
            class="w-[500px] min-h-[600px] bg-white p-6 rounded-lg shadow-lg flex flex-col justify-center items-center">
            ...
            <p class="text-neutral-600 mt-2 text-center">
                Your file has been successfully updated. You can now access it or update more files.</p>
            <div class="mt-6">
                <button class="bg-primary-500 h-[40px] w-[150px] text-primary-50 rounded-full">Go to Files</button>
            </div>
        </div>
    </div>
</body>
